...
直接輸出，不要多餘的前言："""
    ...
    try:
        ...
        summary = summary.replace("X 篇", f"{total} 篇")
        return summary
    except Exception as e:
...
if __name__ == "__main__":
    ...
    if summary:
        ...
        with open(summary_file, "w", encoding="utf-8") as f:
            json.dump({"date": str(date.today()), "summary": summary}, f, ensure_ascii=False, indent=2)
